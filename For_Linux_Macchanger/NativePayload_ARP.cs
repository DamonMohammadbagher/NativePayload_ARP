                ...
                try
                {
                    while (true)
                    {
                        ...
                        if (_mac == 0)
                        {
                            ...
                            if (MacAddress.Count == 0 && tmp.ToString() != "ffffffffff" && tmp.ToString() != "ff00ff00ff" && init && temp_arps_2.ToString().Substring(0,2)=="00")
                            {
                                MacAddress.Add(tmp);
                            ...
                            else
                            {
                                ...
                                if (init)
                                {
                                    ...
                                    if (MacAddress.Capacity != 0 && MacAddress.AsEnumerable().Last().ToString() != tmp && init_countdown > 1 && temp_arps_2.ToString().Substring(0, 2) == "00")
                                    {
                                        MacAddress.Add(tmp);
                                        Console.ForegroundColor = ConsoleColor.Cyan;
                                        Console.WriteLine("[" + init_countdown.ToString() + "] Dumping Bytes: " + MacAddress.AsEnumerable().AsQueryable().Last().ToString());
